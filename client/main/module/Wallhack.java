...
import client.main.event.EventLoadBlock;
...
public class Wallhack extends Module {
		...
		if (isEnabled()) {
			for (Location l : blocks) {
				Block block = mc.world
						.getBlockState(new BlockPos((double) l.getX(), (double) l.getY(), (double) l.getZ()))
						.getBlock();
	...
	public void onLoadBlock(EventLoadBlock e) {
		...
		double dist = Client.getMinecraft().player
				.getDistanceSqToCenter(new BlockPos((double) pos.getX(), (double) pos.getY(), (double) pos.getZ()));
		if (max || (!max && dist <= 100)) {
	...
	private void refresh() {
		...
		mc.world.markBlockRangeForRenderUpdate(new BlockPos(p.posX - d, p.posY - d, p.posZ - d),
				new BlockPos(p.posX + d, p.posY + d, p.posZ + d));
	}
	...
	private void drawBlock(Location l) {
		...
		Color c = new Color(state.getMapColor(mc.world,
				new BlockPos((double) l.getX(), (double) l.getY(), (double) l.getZ())).colorValue);
		GL11.glPushMatrix();
		...
		Block up = mc.world.getBlockState(new BlockPos((double) l.getX(), (double) l.getY() + 1, (double) l.getZ()))
				.getBlock();
		Block down = mc.world.getBlockState(new BlockPos((double) l.getX(), (double) l.getY() - 1, (double) l.getZ()))
				.getBlock();
		Block left = mc.world.getBlockState(new BlockPos((double) l.getX() - 1, (double) l.getY(), (double) l.getZ()))
				.getBlock();
		Block right = mc.world.getBlockState(new BlockPos((double) l.getX() + 1, (double) l.getY(), (double) l.getZ()))
				.getBlock(); // gonna use adjacent later
		Block forward = mc.world
				.getBlockState(new BlockPos((double) l.getX(), (double) l.getY(), (double) l.getZ() + 1)).getBlock();
		Block backward = mc.world
				.getBlockState(new BlockPos((double) l.getX(), (double) l.getY(), (double) l.getZ() - 1)).getBlock();
